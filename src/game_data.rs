...
pub enum BehaviourType {
	Dvd { bounds: Option<AssetBounds>, use_world_bounds: Option<bool>, speed: PhysicsVector },
	Controllable { bounds: Option<AssetBounds>, use_world_bounds: Option<bool>, speed: f32, run_speed: f32 },
	Collision { bounds: Option<AssetBounds>, use_world_bounds: Option<bool> },
}
